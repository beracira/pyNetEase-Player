...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.radioButton_Song = QtWidgets.QRadioButton(Form)
        self.radioButton_Song.setObjectName("radioButton_Song")
        self.horizontalLayout.addWidget(self.radioButton_Song)
        self.radioButton_Singer = QtWidgets.QRadioButton(Form)
        self.radioButton_Singer.setObjectName("radioButton_Singer")
        self.horizontalLayout.addWidget(self.radioButton_Singer)
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButton_Song.setText(_translate("Form", "Song"))
        self.radioButton_Singer.setText(_translate("Form", "Singer"))
        self.radioButton_Album.setText(_translate("Form", "Album"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Song"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Singer"))
